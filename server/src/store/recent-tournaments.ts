...
// Inserts a freshly-created tournament with status='pending'. Slice 9
// will call this from the (yet-to-exist) POST /api/v1/tournaments
// handler. Kept here so the API surface is in place; intentionally
